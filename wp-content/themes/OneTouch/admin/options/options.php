...
if ( ! class_exists('NHP_Options') ){
    ...
    $fslashed_dir = get_template_directory().'/admin/options/';
    $fslashed_abs = get_template_directory_uri().'/admin/options/';
    ...
    if(!defined('NHP_OPTIONS_URL')){
        define('NHP_OPTIONS_URL', $fslashed_abs );
    }
    ...
    class NHP_Options{
        ...
        function generate_options_css($newdata) {
            ...
            if ( ! $wp_filesystem->put_contents( $css_dir . 'options.css', $css, 0644) ) {
                file_put_contents( $css_dir . 'options.css', $css );
                return true;
            }
